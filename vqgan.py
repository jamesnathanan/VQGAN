...
#@title Parameters for Neural Network
text = "No more sun, only night. In the dark, a red ghost come out with skeleton" #@param {type:"string"}
textos = text
...
modelo=model
interval_image =  30#@param {type:"number"}
intervalo_imagenes = interval_image
initial_image = "starry-night.jpg"#@param {type:"string"}
imagen_inicial= initial_image
objective_image = None#@param {type:"string"}
...
"""# **Optional: ESRGAN for increasing resolution**
